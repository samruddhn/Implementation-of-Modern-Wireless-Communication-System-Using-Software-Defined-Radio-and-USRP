...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/elementa/Desktop/30MARCH/TEXT/VARIATION/SENT.odt', True)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, '/home/elementa/Desktop/30MARCH/TEXT/VARIATION/RECEIVED.odt', False)
